...
impl SyscallsStubs {
    ...
    fn new(syscalls: &mut Syscalls) -> () {
        ...
        syscalls.register(331, &stubs, |_, _| {
            warn!("stubbed sys_sched_yield");
            Ok(0.into())
        });
        syscalls.register(203, &stubs, |_, _| {
            warn!("stubbed sys_mlock");
            Ok(0.into())
        });
        syscalls.register(95, &stubs, |_, _| {
            warn!("stubbed sys_fsync");
            Ok(0.into())
        });
        syscalls.register(232, &stubs, |_, i| {
        ...
        syscalls.register(455, &stubs, |_, i| {
        ...
        syscalls.register(454, &stubs, |s, i| {
        ...
        syscalls.register(488, &stubs, |_, i| {
            let arg1: usize = i.args[0].into();
            let arg2: usize = i.args[1].into();
            let arg3: usize = i.args[2].into();
            let arg4: usize = i.args[3].into();
        ...
        syscalls.register(99, &stubs, |_, i| {
            let arg1: usize = i.args[0].into();
            let arg2: usize = i.args[1].into();
            let arg3: usize = i.args[2].into();
            let arg4: usize = i.args[3].into();
        ...
        syscalls.register(113, &stubs, |_, _| Ok(666.into()));
