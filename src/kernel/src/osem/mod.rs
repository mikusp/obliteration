...
impl OsemManager {
    ...
    fn sys_osem_delete(self: &Arc<Self>, td: &VThread, i: &SysIn) -> Result<SysOut, SysErr> {
    ...
    fn sys_osem_open(self: &Arc<Self>, td: &VThread, i: &SysIn) -> Result<SysOut, SysErr> {
    ...
    fn sys_osem_wait(self: &Arc<Self>, td: &VThread, i: &SysIn) -> Result<SysOut, SysErr> {
        let sem_id = i.args[0].into();
    ...
    fn sys_osem_post(self: &Arc<Self>, td: &VThread, i: &SysIn) -> Result<SysOut, SysErr> {
        let sem_id = i.args[0].into();
